...
enum TBeamParameter {X_PAR,TH_PAR,BX_PAR,BTH_PAR,BZ_PAR,PHI_PAR,BETA_PAR} ;     //R_PAR
...
struct TParticle
{
	double x;  //x/lmb (-Rb<x<Rb) - rename to r
	double x0; //add desciption
    double Th;
	double Bx; //rename to Br
	double Bth;
	double phi;
	double Bz;
	double z;
	double betta; //distinguish beta from bz!
    TLoss lost;
};
...
//---------------------------------------------------------------------------
inline double RadToDeg(double a){     //Should be romved from the code!
    return a*180/pi;
}
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
inline double DegToRad(double phi){       //Should be romved from the code!
	return phi*pi/180;
}
//---------------------------------------------------------------------------
